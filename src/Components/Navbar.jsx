...
const Navbar = () => {
    return (
        <>
            <div className="md:hidden navbar flex justify-between items-center p-2 md:my-6">
                ...
                <div className="logo text-center md:h-1.5 flex ">
                    ...
                    <div className="feature -translate-x-96 md:translate-x-0 md:mx-5 absolute md:static md:flex md:visible space-x-3 ">
                        <div className="fitem"><Link>Microsoft 365</Link></div>
                        <div className="fitem"><Link>Office</Link></div>
                        <div className="fitem"><Link>Windows</Link></div>
                        <div className="fitem"><Link>Resources</Link></div>
                    </div>
                </div>
            ...
            <div className=" md:visible slider1 flex flex-col-reverse my-14 md:flex-row justify-center items-center px-6">
                ...
                <div className="left w-screen">
                    <div className="text-l4 text-[#4b53bc] text-[1.8125rem] font-semibold items-baseline px-3">Microsoft Teams</div>
                    <div className="textl3 text-[1.2rem] px-3 font-semibold my-4">Make amazing things happen together at home, work, and school.</div>
                    <div><button className="bg-[#4b53bc] hover:bg-[#2a307f] text-white font-bold w-3/4 my-3 py-2 px-4 border border-blue-700 rounded">
                        SignUp For Free
                    </button></div>
                    <div><button className="bg-[#4b53bc] hover:bg-[#2a307f] text-white font-bold w-3/4 py-2 px-4 border border-blue-700 rounded">
                        SignUp For Free
                    </button></div>
                    <div className="textl3 text-[#4b53bc] text-[1.2rem] px-3 font-semibold my-4">Sign in.</div>
                </div>
